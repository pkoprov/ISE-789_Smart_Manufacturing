...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    cv.rectangle(frame, (left, bottom - round(0.75*labelSize[1])), (left + round(0.75*labelSize[0]), bottom + baseLine), (255, 255, 255), cv.FILLED)
    cv.putText(frame, label, (left, bottom), cv.FONT_HERSHEY_COMPLEX, 0.75, (255,0,0), 1)
...
parser = argparse.ArgumentParser(description='Object Detection using TinyYOLOV4')
