...
cv2.createTrackbar("Area", "Parameters", 5, 10, empty)
# cv2.createTrackbar("winStride", "Parameters", 1, 3, empty)
# cv2.createTrackbar("padding", "Parameters", 0, 3, empty)
# cv2.createTrackbar("scale", "Parameters", 1, 6, empty)
df = pnd.DataFrame()

for areaThresh in (2, 3, 5, 7, 9):
    areaThresh = areaThresh*10000
    for sc in range(7):
        sc = 1 + sc / 100
        for wS in range(4):
            wS = getPar(wS)
            for pd in range(4):
                ...
                # wS = cv2.getTrackbarPos("winStride", "Parameters")

                # pd = cv2.getTrackbarPos("padding", "Parameters")

                # sc = cv2.getTrackbarPos("scale", "Parameters")
                ...
                while True:
                    ...
                    for cnt in contours:
                        ...
                        # areaThresh = cv2.getTrackbarPos("Area", "Parameters")*10000
                        if area > areaThresh:
